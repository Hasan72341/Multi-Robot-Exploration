...
def launch_setup(context):
    ...
    number_of_robots = int(LaunchConfiguration('robot_number').perform(context))
    map_number = int(LaunchConfiguration('map_number').perform(context))

    robots = gen_robot_list(number_of_robots, map_number)
    spawn_launch = os.path.join(get_package_share_directory(package_name), 'launch', 'spawn_robots.launch.py')
